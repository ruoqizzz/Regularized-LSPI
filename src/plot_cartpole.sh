for z in {1..10}; do
	...
	# python3 run_cartpole_video_RBF.py --basis_function 100 --reg_param 0.1 --reg_opt l2 --samples_episodes 200
	...
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_opt wl1 --samples_episodes 200
	
	
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.01 --reg_opt l1 --samples_episodes 200
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.01 --reg_opt l2 --samples_episodes 200
	# python3 run_cartpole_video_Laplace.py --basis_function 10 --reg_param 0.1 --reg_opt l2 --samples_episodes 200
	
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.1 --reg_opt l1 --samples_episodes 200
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.1 --reg_opt l2 --samples_episodes 200

	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.01 --reg_opt l1 --samples_episodes 200
	# python3 run_cartpole_video_Laplace.py --basis_function 30 --reg_param 0.001 --reg_opt l1 --samples_episodes 200
