...
def main():
	...
	agent = LSPIAgent(params, n_iter_max=15)
	...
	path = "data/CartPole/[theta, theta_dot]-1/"+str(agent.opt)+"-"+str(agent.reg_param)+"-LP"+str(agent.policy.basis_func.size())+'-LSPI'+"/"+now2+"/"
