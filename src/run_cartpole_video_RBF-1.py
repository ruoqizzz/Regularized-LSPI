...
def main():
	...
	agent = BellmanAgent(params, n_iter_max=lspi_iteration)
	...
	path = "data/CartPole/[theta, theta_dot]-1/"+str(agent.opt)+"-"+str(agent.reg_param)+"-BF"+str(agent.policy.basis_func.size())+"-Bellman/"+now2+"/"
